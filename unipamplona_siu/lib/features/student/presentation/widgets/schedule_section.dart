...
class ScheduleSection extends StatelessWidget {
  ...
  Widget _hourCell(String hour) => Container(
    ...
    child: Text(hour,
      textAlign: TextAlign.center,
      style: const TextStyle(fontSize: 9, color: AppColors.gray600, fontWeight: FontWeight.w600),
    ),
  );
      ...
      child: Column(
        ...
        children: [
          ...
          if (s.room.isNotEmpty)
            Text(s.room,
              style: TextStyle(fontSize: 8, color: fg.withValues(alpha: 0.75)),
            ),
        ],
      ),
    );
...
// Extension para gray600 no definido aún
